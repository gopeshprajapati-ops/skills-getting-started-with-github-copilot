...
activities = {
    ...
    "Swim Club": {
        "description": "Develop swimming skills and compete in friendly meets",
    ...
    "Drama Club": {
        "description": "Practice acting and put on theater productions",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "james@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and argument skills for competitions",
